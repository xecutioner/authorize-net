  ...
  class Order
    ...
    def add_line_item(id = nil, name = nil, description = nil, quantity = nil, price = nil, taxable = nil)
      if id.kind_of?(AuthorizeNet::LineItem)
        ...
        line_item = AuthorizeNet::LineItem.new({:line_item_id => id, :line_item_name => name, :line_item_description => description, :line_item_quantity => quantity, :line_item_unit_price => price, :line_item_taxable => taxable})
      end
